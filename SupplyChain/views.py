    ...
    def post(self, request):
        ...
        try:
            with open(path) as file:
                ...
                adf_dict = {'parameters': {}, '$schema': param_file['general']['schema'],
                            'contentVersion': param_file['general']['contentVersion']}
                vault_dict = {'parameters': {}, '$schema': param_file['general']['schema'],
                              'contentVersion': param_file['general']['contentVersion']}
